# STAGE 027 — Implement interactive install flow with semantic questions
...
1. Ask only final 5 semantic blocks
2. Do silent technical detection
3. No final confirmation
4. Use test stdin fixture only for tests
...
5. Write `.devplan/HANDOFFS/STAGE_027.md`.
