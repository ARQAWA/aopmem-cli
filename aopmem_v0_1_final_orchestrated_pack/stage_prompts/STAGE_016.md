# STAGE 016 — Add FTS5 table and indexing hooks
...
2. Index title summary body aliases
3. Keep FTS updated on node create/update
4. No vector/semantic code
...
5. Write `.devplan/HANDOFFS/STAGE_016.md`.
