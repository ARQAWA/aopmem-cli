# STAGE 012 — Implement links table and link add/list
...
2. Implement link add/list
3. Validate source/target nodes exist
4. Prevent broken links
...
5. Write `.devplan/HANDOFFS/STAGE_012.md`.
