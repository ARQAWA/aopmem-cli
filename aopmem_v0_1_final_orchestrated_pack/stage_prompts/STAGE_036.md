# STAGE 036 — Implement artifact paths and cleanup
...
1. Create daily artifact folders
2. Cleanup by 7 days or 1GB
3. Never delete DB/tools/logs/audit
...
5. Write `.devplan/HANDOFFS/STAGE_036.md`.
