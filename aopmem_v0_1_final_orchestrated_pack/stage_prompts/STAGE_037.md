# STAGE 037 — Implement audit-git SQL dump snapshot
...
1. Generate SQL dump/snapshot for audit-git
2. Do not commit binary DB
3. Provide command or internal function after memory writes
...
5. Write `.devplan/HANDOFFS/STAGE_037.md`.
