# STAGE 032 — Implement tool registry and tool.json model
...
1. Define tool contract schema
2. Store canonical registry in SQLite
3. Emit/read tool.json near tool
...
5. Write `.devplan/HANDOFFS/STAGE_032.md`.
