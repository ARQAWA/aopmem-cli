# STAGE 031 — Implement corporate MCP registry CRUD
...
1. Create/list/get/add MCP profiles
2. Registry may be empty
3. Side effects and approval class stored
...
5. Write `.devplan/HANDOFFS/STAGE_031.md`.
