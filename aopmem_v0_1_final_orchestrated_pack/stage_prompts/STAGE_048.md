# STAGE 048 — Implement drift check
...
1. Detect adapter block drift
2. Detect schema drift
3. Detect forbidden feature terms in code paths if feasible
...
5. Write `.devplan/HANDOFFS/STAGE_048.md`.
