# STAGE 008 — Add global/workspace directory creation
...
1. Create ~/.aopmem structure
2. Create workspace structure
3. Ensure artifacts/tools/logs/audit-git/runtimes dirs
4. No repo-local .aopmem
...
5. Write `.devplan/HANDOFFS/STAGE_008.md`.
