# STAGE 005 — Add JSON envelope and exit code model
...
1. Implement JSON output envelope for --json
2. Implement fixed exit code constants
3. Add tests for success and error envelopes
...
5. Write `.devplan/HANDOFFS/STAGE_005.md`.
