# STAGE 042 — Implement reflection proposal schema
...
1. Define structured proposal JSON schema in code/tests
2. Accept proposal files
3. Validate low/high risk item types
...
5. Write `.devplan/HANDOFFS/STAGE_042.md`.
