# STAGE 010 — Add migration system and schema v1 skeleton
...
2. Add migration 001_init skeleton
3. Ensure idempotent migration
...
5. Write `.devplan/HANDOFFS/STAGE_010.md`.
