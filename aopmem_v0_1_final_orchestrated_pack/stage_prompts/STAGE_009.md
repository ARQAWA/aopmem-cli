# STAGE 009 — Add SQLite connection and pragmas
...
1. Open per-workspace SQLite DB
2. Apply foreign_keys/WAL/busy_timeout pragmas
3. Add test opening DB
...
5. Write `.devplan/HANDOFFS/STAGE_009.md`.
