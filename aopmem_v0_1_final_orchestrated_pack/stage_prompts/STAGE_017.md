# STAGE 017 — Implement structured recall base
...
1. Implement recall command returning project profile/gates/workflows by type/status
2. No FTS yet in this stage
3. Return JSON bundle
...
5. Write `.devplan/HANDOFFS/STAGE_017.md`.
