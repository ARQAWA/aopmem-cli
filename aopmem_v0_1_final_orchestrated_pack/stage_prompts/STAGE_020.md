# STAGE 020 — Implement hunch selection
...
1. Select 1-3 hunches by FTS match + linked workflow/tool/failure_mode + hotness
2. Every hunch must include source node id
3. Hunch is not source of truth
...
5. Write `.devplan/HANDOFFS/STAGE_020.md`.
