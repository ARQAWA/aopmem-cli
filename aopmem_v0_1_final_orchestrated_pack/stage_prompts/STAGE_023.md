# STAGE 023 — Implement adapter managed block seed
...
1. Insert managed block with markers into detected/provided instruction file
2. Do not overwrite outside block
...
5. Write `.devplan/HANDOFFS/STAGE_023.md`.
