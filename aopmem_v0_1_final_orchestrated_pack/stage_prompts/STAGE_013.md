# STAGE 013 — Implement aliases/tags/sources tables
...
1. Create aliases/tags/sources
2. Implement minimal add/list through node operations or direct commands
3. Ensure FTS can later use aliases
...
5. Write `.devplan/HANDOFFS/STAGE_013.md`.
