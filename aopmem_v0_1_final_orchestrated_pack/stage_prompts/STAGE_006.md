# STAGE 006 — Add user-level path resolver
...
1. Resolve AOPMEM_HOME override
2. Default to ~/.aopmem
3. Do not create files yet except in explicit commands
4. Add tests using temp HOME/AOPMEM_HOME
...
5. Write `.devplan/HANDOFFS/STAGE_006.md`.
