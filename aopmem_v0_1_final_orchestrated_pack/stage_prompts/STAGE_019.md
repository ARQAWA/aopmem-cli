# STAGE 019 — Implement FTS/BM25 fallback
...
1. Use FTS5 bm25 order ascending
2. Add fallback results when structured recall insufficient
3. No semantic/vector
...
5. Write `.devplan/HANDOFFS/STAGE_019.md`.
