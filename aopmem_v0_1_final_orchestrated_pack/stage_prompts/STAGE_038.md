# STAGE 038 — Implement doctor command
...
1. Check global dirs, workspace, DB, schema, FTS, adapter block, artifacts dirs, tools dirs
2. Return JSON health
...
5. Write `.devplan/HANDOFFS/STAGE_038.md`.
