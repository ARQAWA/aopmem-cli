# STAGE 015 — Implement registries base
...
1. Create registries/mcp/tool/workflow base tables or registry table
2. Add minimal list/get/add for mcp profiles
...
5. Write `.devplan/HANDOFFS/STAGE_015.md`.
