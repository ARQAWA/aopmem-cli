# STAGE 003 — Add dependency justification mechanism
...
1. Add only dependencies needed for near-term CLI/storage
2. For every dependency in Cargo.toml add justification in DEPS_JUSTIFICATION.md
3. Do not add unneeded crates
...
5. Write `.devplan/HANDOFFS/STAGE_003.md`.
