# STAGE 025 — Implement global install check
...
1. Implement status for global install dirs/bin/templates
2. Do not ask/report technical details unless error
...
5. Write `.devplan/HANDOFFS/STAGE_025.md`.
