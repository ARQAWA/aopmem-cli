# STAGE 034 — Implement tool validate
...
1. Validate tool.json required fields
2. Validate executable path if present
3. Validate side effects enum/examples
...
5. Write `.devplan/HANDOFFS/STAGE_034.md`.
