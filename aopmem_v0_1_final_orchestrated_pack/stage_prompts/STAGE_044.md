# STAGE 044 — Implement approval flag handling
...
1. Any +++ passed via approval flag accepted
2. External/high-risk side effects blocked without approval
...
5. Write `.devplan/HANDOFFS/STAGE_044.md`.
