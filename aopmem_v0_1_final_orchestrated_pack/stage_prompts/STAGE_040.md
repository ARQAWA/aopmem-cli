# STAGE 040 — Implement teach session storage
...
1. Teach start/add/propose/apply storage mechanics
2. Agent provides structured proposal
3. CLI stores/apply per risk policy
...
5. Write `.devplan/HANDOFFS/STAGE_040.md`.
