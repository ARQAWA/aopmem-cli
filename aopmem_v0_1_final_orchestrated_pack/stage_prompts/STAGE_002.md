# STAGE 002 — Create Rust crate skeleton
...
1. Create single Rust crate named aopmem
2. Add src/main.rs
3. Create module folders declared in FINAL_DECISION_LOG
4. Add minimal main that exits successfully for --help/version only if implemented
...
5. Write `.devplan/HANDOFFS/STAGE_002.md`.
