# STAGE 035 — Implement aopmem tool run
...
1. Run generated tool via registry
2. Do not require agents to call binaries directly
3. Enforce approval for side-effectful tools
...
5. Write `.devplan/HANDOFFS/STAGE_035.md`.
