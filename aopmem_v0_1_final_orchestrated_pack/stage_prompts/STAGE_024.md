# STAGE 024 — Implement adapter sync/status/drift detection
...
1. Detect existing block
2. Replace only block
3. Detect damaged block and return drift/conflict error
...
5. Write `.devplan/HANDOFFS/STAGE_024.md`.
