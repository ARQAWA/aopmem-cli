# STAGE 030 — Implement Codebase Memory MCP registry/profile
...
1. Register Codebase MCP profile
2. Best-effort status follows final optional MCP status contract:
   disabled/installed/missing/configured_unverified
3. No real MCP calls required
...
5. Write `.devplan/HANDOFFS/STAGE_030.md`.
