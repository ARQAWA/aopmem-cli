# STAGE 018 — Implement graph traversal
...
1. Expand recall through links from selected workflow/tool/rules
2. Limit traversal depth
3. Exclude deprecated/superseded
...
5. Write `.devplan/HANDOFFS/STAGE_018.md`.
