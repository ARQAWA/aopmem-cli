# STAGE 046 — Implement lint command
...
1. Check duplicate IDs, broken links, deprecated active links, missing source, missing summary, missing gates
...
5. Write `.devplan/HANDOFFS/STAGE_046.md`.
