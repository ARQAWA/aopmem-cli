# STAGE 021 — Implement recall bundle shaping and limits
...
1. Add compact context bundle format
2. Add source refs/confidence/trust
3. Keep output bounded
4. Add tests for max hunch count
...
5. Write `.devplan/HANDOFFS/STAGE_021.md`.
