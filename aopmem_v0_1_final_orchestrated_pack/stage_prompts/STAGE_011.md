# STAGE 011 — Implement nodes table and node create/get/list
...
2. Implement node create/get/list commands
3. Validate allowed node types/statuses
4. Require source for active where applicable
...
5. Write `.devplan/HANDOFFS/STAGE_011.md`.
